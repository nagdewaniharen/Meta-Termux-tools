...
`
        ...
        // STANDARD LANDING PAGE PROMPT (Conversion, Sales, Short)
        prompt = `You are an expert copywriter specializing in high-conversion landing pages.
Create persuasive, sales-oriented content.

TITLE: "${input.title}"
PRIMARY KEYWORD: "${input.keyword}"
CONTEXT:
- Tone: Persuasive, energetic, and confidence-inspiring.
- Structure: Sales funnel structure (Hook -> Problem -> Solution -> Benefits -> Close).
...
1. HEADLINE: Punchy, benefit-driven headline.
2. SUBHEADLINE: Supporting statement reinforcing the promise.
3. META DESCRIPTION: 120-160 chars.
4. CTA TEXT: High interaction (e.g., "Get Offer", "Sign Up Now").

5. SECTIONS (MUST BE 6):
   - Section 1: "Hero/Intro" — The main hook.
   - Section 2: "The Problem" — Agitate the user's pain point.
   - Section 3: "The Solution" — Introduce the product/service/idea.
   - Section 4: "Benefits" — Key advantages (bullet points).
   - Section 5: "Social Proof/Trust" — Why trust this?
   - Section 6: "Conclusion/CTA" — Final push.
